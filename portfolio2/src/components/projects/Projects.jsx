    ...
    <section className="experience min-h-[100vh] lg:h-[90vh] bg-primary  flex flex-col items-center pt-[4rem] lg:pt-[8rem] lg:px-[11rem]">
      ...
      ">
        ...
        <div className="main flex gap-[80px]">
          ...
          {projects.map((item, index) =>
            <div key={item.id} className={project === index ? "project-card relative h-[fit] flex flex-1 gap-[40px] justify-end bg-secondary bg-opacity-[0.06] border-[3px] rounded-xl border-secondary border-opacity-[0.05] p-[30px]" : "project-card hidden"}>

              <div className="desc text-left flex flex-col flex-[1] justify-center">

                <div className="text-data">
                  <h1 className='text-[white] text-[1.8rem] mb-[30px] '>{item.head}</h1>
                ...
                <div className="icons flex  gap-[50px] mt-[20px]">
                  <span className='group cursor-pointer' ><svg width="45" height="30" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className=' cursor-pointer'  ><svg width="30" height="30" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
