...
export default function Btn() {
  return (
    <div className='relative w-fit' >
      <button className='flex  flex-row-reverse group text-[20px] relative  text-[white]  gap-2 md:gap-3 items-center rounded-[10px] py-[12px] border-secondary border-2
      px-[15px] lg:py-[20px] lg:px-[50px] md:text-[30px] font-medium overflow-hidden z-[10] hover:ease-in-out
      after:absolute after:bg-[white] hover:border-0  after:left-0 after:right-[0] after:opacity-0 hover:after:opacity-100 after:top-0 after:bottom-0 after:z-[-1]
