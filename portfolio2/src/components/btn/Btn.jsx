...
export default function Btn() {
  return (
    <div className='relative w-fit' >
      <button className='flex  flex-row-reverse group text-[20px] relative  text-[white]  gap-2 md:gap-3 items-center rounded-[10px] py-[12px]  border-2
      px-[15px] lg:py-[20px] lg:px-[30px] 3xl:px-[50px] md:text-[30px] font-medium overflow-hidden z-[10] hover:ease-in-out
